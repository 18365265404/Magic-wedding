<template>
    <div class="header">
        ...
        <div class="logo" style="font-size:18px">素材平台系统</div>
        <!-- 折叠按钮 -->
            ...
            <div class="header-user-con">
                ...
                <el-dropdown style="margin-top:-20px" class="user-name" trigger="click" @command="handleCommand">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <el-button style="display:none" @click="changePWord()">修改密码</el-button>
...
<script>
    ...
    export default {
        ...
        computed:{
            username(){
                let username = localStorage.getItem('ms_username2');

                    ...
                    if (valid) {
                        ...
                        postRequestLogin(url.loginGoLogin, {
                            ...
                            passWord: this.ruleForm.password
                                ...
                                console.log("login成功数据",data.data.data.nickName)
                              
                                sessionStorage.putSessionStorage('ms_userId',this.ruleForm.username)
                                localStorage.setItem('ms_username2',this.ruleForm.username);
                                this.$router.push('/');
